"""
Final Review Generator: the last of the 9 agents. Synthesizes ALL prior
assessments (Paper Understanding, Figure & Table, Novelty, Methodology,
Citation, Evidence & Reproducibility, Reflection) into the structured
review format the whole project was originally scoped to produce: Paper
Summary, Strengths, Weaknesses, Questions for Authors, Novelty Analysis,
Citation Quality, Reproducibility, Evidence Mapping, Missing Baselines,
...
despite covering more sources (7 vs. 4).
...
from core.schemas.agent_output_schemas import (
    ...
    ReflectionNotes, FinalReview,
)
from core.agents.assessment_formatters import (
    format_understanding, format_figure_table, format_novelty,
    format_methodology, format_citation, format_evidence_repro, format_reflection,
)
